	...
	return (
		<div className=" mt-12 grid lg:grid-flow-col ">
			<div>
				...
				<AnimatedDiv animationType="perspective">
					<div
						style={!isMobile ? { transform: "translateX(10%)" } : {}}
						className=" bg-purple_taupe py-4 pb-6 px-4 grid place-items-center lg:w-fit lg:py-10 lg:pb-14 lg:px-16"
					>
						<h3
							className="font-black mb-[20px] uppercase lg:text-3xl lg:justify-self-start"
						>
							Customer experience
						</h3>
			...
			<div className="lg:grid -order-1 lg:order-1">
				...
				<div className="relative -z-10 w-full lg:-order-1 ">
					<AnimatedDiv animationType="fadeDownLeft">
